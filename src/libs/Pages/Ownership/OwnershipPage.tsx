...
export const OwnershipPage = (props: Props) => {
	return (
		<Suspense fallback={<OwnershipPageSkeleton />}>
			<OwnershipPageInner {...props} />
		</Suspense>
	);
};

const OwnershipPageSkeleton = () => (
...
const OwnershipPageInner = async ({ params }: Props) => {
